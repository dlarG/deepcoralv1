...
@biologist_bp.route('/biologist/corals', methods=['POST'])
@biologist_required
@login_required
def add_coral():
    try:
...
@biologist_bp.route('/biologist/corals/<int:coral_id>', methods=['PUT'])
@biologist_required
@login_required
...
@biologist_bp.route('/biologist/corals/<int:coral_id>', methods=['DELETE'])
@biologist_required
@login_required
