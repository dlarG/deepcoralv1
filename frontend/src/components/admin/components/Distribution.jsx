...
function Distribution() {
  ...
  const confirmDelete = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `http://localhost:5000/distribution/images/${imageToDelete.id}`,
        {
          method: "DELETE",
          credentials: "include",
          headers: {
  ...
  const loadInitialData = async () => {
    try {
      ...
      const dateRangeResponse = await fetch(
        "http://localhost:5000/distribution/date-range"
      );
  ...
  const loadLocations = async () => {
    try {
      ...
      const url = params.toString()
        ? `http://localhost:5000/distribution/locations?${params}`
        : "http://localhost:5000/distribution/locations";
  ...
  const handleLocationClick = async (location) => {
    ...
    try {
      ...
      const imagesUrl = paramString
        ? `http://localhost:5000/distribution/location/${location.latitude}/${location.longitude}/images?${paramString}`
        : `http://localhost:5000/distribution/location/${location.latitude}/${location.longitude}/images`;
      ...
      const analyticsUrl = paramString
        ? `http://localhost:5000/distribution/location/${location.latitude}/${location.longitude}/analytics?${paramString}`
        : `http://localhost:5000/distribution/location/${location.latitude}/${location.longitude}/analytics`;
  ...
  const handleDateRangeChange = async () => {
    ...
    if (selectedLocation) {
      await handleLocationClick(selectedLocation);
    }
  };
  ...
  const renderCoralDistributionChart = () => {
    if (
      ...
      return (
        <div className="no-data-message">
          ...
          <p>No coral analysis data found for this location and date range.</p>
        </div>
      );
    }
    ...
    const options = {
      ...
      plugins: {
        ...
        title: {
          display: true,
          text: "Coral Coverage Distribution",
          font: {
            size: 18,
            weight: "bold",
          },
  ...
  const renderTrendChart = () => {
    if (
      ...
      return (
        <div className="no-data-message">
          ...
          <p>Insufficient data points to show trends. Need multiple dates.</p>
        </div>
      );
    }
    ...
    const options = {
      ...
      plugins: {
        ...
        title: {
          display: true,
          text: "Coral Coverage Trends Over Time",
          font: {
            size: 18,
            weight: "bold",
          },
  ...
  const renderCategoriesPieChart = () => {
    if (
      ...
      return (
        <div className="no-data-message">
          ...
          <p>No coral category data found for analysis.</p>
        </div>
      );
    }
    ...
    const options = {
      ...
      plugins: {
        ...
        title: {
          display: true,
          text: "Coral Categories Distribution",
          font: {
            size: 18,
            weight: "bold",
          },
              ...
              <div className="location-details-sidebar">
                ...
                <div className="location-info">
                  ...
                  <div className="location-info-card">
                    ...
                    <p>
                      <strong>Date Range:</strong> {selectedLocation.date_range}
                    </p>
                  </div>
                </div>
              ...
              <div className="image-viewer-modal-body">
                <div className="image-display-container">
                  <div className="main-image-wrapper">
                    <img
                      src={`http://localhost:5000/crops/${locationImages[currentImageIndex].filename}`}
